...
Материалы на русском языке рядом с корневым [**GUIDE.md**](../GUIDE.md) (крупный справочник по всему `config.yaml`).

| Документ | Назначение |
|----------|------------|
| [**REFERENCE-META-DOCS.md**](REFERENCE-META-DOCS.md) | Клонирование [Meta-Docs](https://github.com/MetaCubeX/Meta-Docs), зачем не коммитить каталог, **таблица соответствия** папок вики разделам **GUIDE.md** и что намеренно вне гайда (API, startup, handbook). |
