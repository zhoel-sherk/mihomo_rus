...
## Перевод был выполнен нейросетями 

Такой объём текста за два дня в соло не сдеать, буду делать ещё аудит тотальный но пока как есть. Читать вики metacubex - боль. Если будет время сделаю перевод и для них исходя из этого гайда. 
